...
import { buildCorsOptions, parseCorsOrigins, preflightCorsMiddleware, resolveCorsAllowOrigin, } from './cors-config.js';
...
export function createApp() {
    ...
    app.get('/api/cors-check', (req, res) => {
        ...
        const decision = origin ? resolveCorsAllowOrigin(env, origin) : { allow: false };
        res.json({
            ok: true,
